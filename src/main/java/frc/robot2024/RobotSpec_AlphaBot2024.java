...
// set this true at least once after robot hw stabilizes
    ...
    // Chassis
    static double kWheelCorrectionFactor = .957;
    static double kSteeringGR = 21.428;
    static double kDriveGR = 6.12;
    static double kWheelDiameter = MperFT * 4.0 / 12.0; // [m]

    static final ChassisConfig comp2024BotAlphaChassisConfig = new ChassisConfig(
        ...
        static {
          comp2024BotAlphaChassisConfig.drivePIDF.setIZone(0.2);
        }
    ...
    public ChassisConfig getChassisConfig() {
        return comp2024BotAlphaChassisConfig;
    }

    @Override
    public ModuleConfig[] getModuleConfigs() {
        // from original constants  Alpha and Beta (comp) have same CAN ID for swerve
        // comp2024AlphaBotOffsets = new WheelOffsets(43.85746387, 24.096825, -65.21481, -43.066333125); //FL BL FR BR
