...
import frc.base.Constants.ChassisConfig;
import frc.base.Constants.ChassisInversionSpecs;
import frc.base.Constants.SubsystemConfig;
import frc.base.Constants.WheelOffsets;
...
public class RobotSpecs {
    ...
    public RobotSpecs(String serialNo) {
        ...
        switch (myRobotName) {
            case SwerveBot:
                myWheelOffsets = frc.base.DriveTrain.swerveBotOffsets;
                myChassisConfig = frc.base.DriveTrain.swerveBotChassisConfig;
            ...
            case CompetitionBot2023:
                myWheelOffsets = frc.base.DriveTrain.compBotOffsets;
                myChassisConfig = frc.base.DriveTrain.compBotChassisConfig;
                mySubsystemConfig = Constants.compBotSubsystemConfig;
                myChassisInversionSpecs = Constants.compBotChassisInversionSpecs;
                break;

            case ChadBot:
                myWheelOffsets = frc.base.DriveTrain.chadBotOffsets;
                myChassisConfig = frc.base.DriveTrain.chadBotChassisConfig;
