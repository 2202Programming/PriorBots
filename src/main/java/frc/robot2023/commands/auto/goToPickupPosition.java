...
public class goToPickupPosition extends Command {
  ...
  if(DriverStation.getAlliance() == DriverStation.Alliance.Blue) { //BLUE ALLIANCE
      pathCommand = MoveToPoseAutobuilder(constraints, frc.base.FieldPoses.bluePickupPoses[pickupSide]);
    }
    else { //RED ALLIANCE
      pathCommand = MoveToPoseAutobuilder(constraints, frc.base.FieldPoses.redPickupPoses[pickupSide]);
    }
