...
import frc.robot2023.Constants;
import frc.robot2023.RobotContainer;
import frc.robot2023.Constants.HorizontalScoringBlock;
import frc.robot2023.Constants.HorizontalScoringSubstation;
...
public class MoveToFactory extends Command {
    ...
    if(DriverStation.getAlliance() == DriverStation.Alliance.Blue) { //BLUE ALLIANCE
      ...
      pathCommand = MoveToPoseAutobuilder(constraints, frc.base.FieldPoses.blueScorePoses[scoringBlock][scoringAdjusted]);
    }
    else { //RED ALLIANCE
      ...
      pathCommand = MoveToPoseAutobuilder(constraints, frc.base.FieldPoses.redScorePoses[scoringBlock][scoringAdjusted]);
    }
