...
import frc.robot2023.commands.utility.NT_Print;
...
public class PlaceMidHighJR extends Command {
  ...
  public boolean isFinished() {
    ...
    if (RobotContainerOrig.RC().dc.rightStickMotionDriver()) {
      cmd.cancel();   //driver aborting, abort the child cmd too.
    }
    return ((commandState == CommandState.Finished) || RobotContainerOrig.RC().dc.rightStickMotionDriver());
  }
