...
package frc.robot2023.subsystems;
...
import frc.robot2023.Constants.DigitalIO;
import frc.robot2023.Constants.PCM1;
import frc.robot2023.Constants.PowerOnPos;
import frc.lib2202.command.WatcherCmd;
import frc.lib2202.NeoServo;
import frc.lib2202.PIDFController;
import frc.lib2202.VelocityControlled;
...
public class Claw_Substyem extends SubsystemBase {
  ...
  public Claw_Substyem() {
    ...
    elbowAngle = (RobotContainerOrig.RC().elbow != null) ? RobotContainerOrig.RC().elbow::getPosition : this::zero;
