...
public class SensorSubsystem extends SubsystemBase {
  ...
  public double getDistanceFront() //returns distance from target (either from Front Lidar or from lime light depending on reliability), -1 if not available
  {
