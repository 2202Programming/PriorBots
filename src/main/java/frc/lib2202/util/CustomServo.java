...
public class CustomServo extends PWM {
    ...
    private final int DefaultMaxServoPWM;
    private final int DefaultMinServoPWM;
    ...
    public CustomServo(final int channel, final double minDegrees, final double maxDegrees, final double minPWMuS,
      ...
      DefaultMaxServoPWM = (int)maxPWMuS;
      DefaultMinServoPWM = (int)minPWMuS;
      int center = (int)(maxPWMuS - minPWMuS)/2;
      // compute range once
      ServoRange = MaxServoAngle - MinServoAngle;
      //TODO FIX bounds - library changed best guess at setBoundsMircrsecones()
      //original: setBounds(DefaultMaxServoPWM, 0.0, 0.0, 0.0, DefaultMinServoPWM);
      setBoundsMicroseconds(DefaultMaxServoPWM, 0, center, 0, DefaultMinServoPWM);
