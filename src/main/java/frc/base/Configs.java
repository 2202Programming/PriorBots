...
public final class Configs {
  public static List<SubsystemConfig> knownConfigs = new ArrayList<SubsystemConfig>();
  ...
  static {
        Configs.knownConfigs.add(comp2024BetaBotSubsystemConfig);
        Configs.knownConfigs.add(comp2024AlphaBotSubsystemConfig);
        Configs.knownConfigs.add(swerveBotSubsystemConfig);
        Configs.knownConfigs.add(doofBotSubsystemConfig);
